                ...
                try {
                    ...
                    const avgAvailability =
                        domainsData.length > 0
                            ? parseFloat(
                                (
                                    domainsData.reduce(
                                        (sum, domain) => sum + Number(domain.availability ?? 0),
                                        0
                                    ) / domainsData.length
                                ).toFixed(2)
                            )
                    ...
                    const avgResponseTime =
                        domainsData.length > 0
                            ? Math.round(
                                domainsData.reduce(
                                    (sum, domain) => sum + Number(domain.network_detail?.ping ?? 0),
                                    0
                                ) / domainsData.length
                            )
                            : 0;
                        ...
                        >
                            {[
                                ...
                                },
                                {
                                    ...
                                    value: `${data.stats.avgAvailability.toFixed(1)}%`,
                                    change: "Stable",
                                ...
                                },
                                {
                                    ...
                                    value: `${(data.stats.avgResponseTime).toLocaleString("en-US", { minimumFractionDigits: 1 })
                                    }ms`,
                                    change: "-12% ce mois",
                                                ...
                                                >
                                                    <div className="flex items-center justify-between text-sm mb-1">
                                                        <div className="flex items-center">
                                                            ...
                                                            <span className="text-gray-700">{cms || "Inconnu(non Cms)"}</span>
                                                        </div>
