...
Route::middleware('auth:sanctum')->post('/domaines/logout', [DomaineController::class, 'logout']);

Route::post('/domaines/{id}/update-scan', [DomaineController::class, 'updateFull']);
